								...
								<tbody>
									...
									{               ?>  
                                        <tr>
                                            ...
                                            <td><a href="editleavetype.php?lid=<?php echo $result->id;?>"><i class="material-icons">mode_edit</i></a>
                                            <a href="manageleavetype.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');"> <i class="material-icons">delete_forever</i></a> </td>
                                        </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
                                </table>
