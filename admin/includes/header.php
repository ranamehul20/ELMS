...
$unreadcount=$query->rowCount();?>
                                ...
                                <span class="badge"><?php echo $unreadcount;?></span></a></li>
...
{               ?>  
                                    ...
                                    <li>
                                        <a href="leave-details.php?leaveid=<?php echo $result->lid;?>">
                                        <div class="notification">
                                            <div class="notification-icon circle cyan"><i class="material-icons">done</i></div>
                                            <div class="notification-text"><p><b><?php echo $result->FirstName." ".$result->LastName;?><br />(<?php echo $result->EmpId;?>)</b> applied for leave</p><span>at <?php echo $result->PostingDate;?></b</span></div>
                                        </div>
                                        </a>
                                    </li>
                                   <?php }} ?>
