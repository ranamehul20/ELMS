                            ...
                            <div class="card-content">
                                ...
                                <div class="row">
                                    <form class="col s12" name="chngpwd" method="post">
										...
										<input id="leavetype" type="text"  class="validate" autocomplete="off" name="leavetype" value="<?php echo $result->LeaveType;?>"  required>
											<label for="leavetype">Leave Type</label>
										</div>


										<div class="input-field col s12">
										<textarea id="textarea1" name="description" class="materialize-textarea" name="description" length="500"><?php echo $result->Description;?></textarea>
