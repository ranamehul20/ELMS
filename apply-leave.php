...
<input placeholder="" id="mask1" name="fromdate" class="masked" type="datetime-local"  required>
</div>
<div class="input-field col m6 s12">
<span for="todate">To Date</span>
<input placeholder="" id="mask1" name="todate" class="masked" type="datetime-local"  required>
</div>
