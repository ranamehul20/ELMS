...
<?php 
$eid=$_SESSION['eid'];
$sql = "SELECT id,LeaveType,ToDate,FromDate,Description,PostingDate,AdminRemarkDate,AdminRemark,Status from tblleaves where empid=:eid";
...
if($stats==1){
 ...
 <?php } ?>
											 ...
											 <td><?php if($stats==2)  { ?>
												<a href="resend.php?lid=<?php echo $result->id; ?>">Resend</a>
											<?php } ?>
											 </td>
